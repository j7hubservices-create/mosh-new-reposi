...
const ThankYou = () => {
  ...
  const orderItems = (location.state as any)?.orderItems || [];
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Your order has been received and is currently pending payment confirmation. 
            Please keep a screenshot or record of your payment.
          </p>
          ...
          {orderItems.length > 0 && (
            <div className="text-left mb-6">
              ...
              <div className="space-y-2 border rounded-lg p-4 bg-gray-50">
                ...
                <div className="flex justify-between items-center font-bold text-purple-700 mt-2 border-t pt-2">
                  <span>Total</span>
