...
const Admin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setFormData({
      ...
      size: "", stock: "", slug: "", original_price: ""
    });
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        <Tabs defaultValue="homepage" className="w-full">
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-center mb-6">
            <TabsList className="flex flex-wrap justify-center sm:justify-start gap-3 w-full">
              <TabsTrigger value="homepage" className="flex-1 sm:flex-none px-4 py-2 rounded-lg text-sm sm:text-base data-[state=active]:bg-primary data-[state=active]:text-white">
                Manage Homepage
              </TabsTrigger>
              <TabsTrigger value="products" className="flex-1 sm:flex-none px-4 py-2 rounded-lg text-sm sm:text-base data-[state=active]:bg-primary data-[state=active]:text-white">
                Products ({products.length})
              </TabsTrigger>
              <TabsTrigger value="orders" className="flex-1 sm:flex-none px-4 py-2 rounded-lg text-sm sm:text-base data-[state=active]:bg-primary data-[state=active]:text-white">
                Orders ({orders.length})
              </TabsTrigger>
              <TabsTrigger value="users" className="flex-1 sm:flex-none px-4 py-2 rounded-lg text-sm sm:text-base data-[state=active]:bg-primary data-[state=active]:text-white">
                Users ({users.length})
              </TabsTrigger>
              <TabsTrigger value="reviews" className="flex-1 sm:flex-none px-4 py-2 rounded-lg text-sm sm:text-base data-[state=active]:bg-primary data-[state=active]:text-white">
          ...
          <TabsContent value="reviews">
            {reviews.length === 0 ? (
              <Card className="p-12 text-center">
                <p className="text-xl text-muted-foreground">No reviews found</p>
              </Card>
            ) : (
              <div className="overflow-x-auto">
                <Table>
