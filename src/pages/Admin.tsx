        ...
        >
          ...
          <TabsContent value="homepage">
            <Card className="p-6 text-center">
              <h2 className="text-2xl font-bold mb-3">Manage Homepage Section</h2>
              <Button
                variant="outline"
                onClick={() => navigate("/admin/sections")}
                className="mx-auto"
                aria-label="Go to manage homepage sections"
              >
                    ...
                    {orders.map((order) => (
                      <TableRow key={order.id}>
                        ...
                        <TableCell className="text-sm max-w-[150px]">
                          ...
                          >
                            <SelectTrigger className="w-full min-w-[120px] sm:w-36">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
          ...
          <TabsContent value="users">
            {users.length === 0 ? (
              ...
              <div className="overflow-x-auto rounded-md shadow-sm">
                <Table
                  className="min-w-[480px] sm:min-w-full"
                  role="grid"
