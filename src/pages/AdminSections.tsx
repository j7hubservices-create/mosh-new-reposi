    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background to-secondary/10">
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div>
                ...
                <DialogContent>
                  ...
                  <form onSubmit={handleSectionSubmit} className="space-y-4">
                    <div>
                      ...
                      <Select value={sectionForm.section_type} onValueChange={(value) => setSectionForm({...sectionForm, section_type: value})}>
                    ...
                    <div><Label>Title</Label><Input value={sectionForm.title} onChange={(e) => setSectionForm({...sectionForm, title: e.target.value})} required/></div>
                    ...
                    <div><Label>Display Order</Label><Input type="number" value={sectionForm.display_order} onChange={(e) => setSectionForm({...sectionForm, display_order: parseInt(e.target.value)})}/></div>
            ...
            <div className="grid gap-4">
              {sections.map((section) => (
                <Card key={section.id} className="p-6 hover:shadow-lg transition rounded-lg flex justify-between items-center">
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold flex items-center gap-2"><Star className="w-6 h-6 text-primary"/>Customer Reviews</h2>
              <Dialog open={reviewDialogOpen} onOpenChange={setReviewDialogOpen}>
                ...
                <DialogContent>
                  ...
                  <form onSubmit={handleReviewSubmit} className="space-y-4">
                    <div><Label>Customer Name</Label><Input value={reviewForm.customer_name} onChange={(e)=>setReviewForm({...reviewForm, customer_name: e.target.value})} required/></div>
                    ...
                    <div><Label>Review Text</Label><Textarea value={reviewForm.review_text} onChange={(e)=>setReviewForm({...reviewForm, review_text:e.target.value})} rows={3} required/></div>
            ...
            <div className="grid gap-4">
              {reviews.map((review) => (
                <Card key={review.id} className="p-6 hover:shadow-lg transition rounded-lg flex justify-between items-center">
                  <div className="flex-1">
                    ...
                    <div className="flex gap-3 items-center text-sm">
                      ...
                      {review.is_featured && <span className="px-2 py-0.5 bg-primary/10 text-primary rounded text-xs">Featured</span>}
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <Button variant="outline" size="icon" onClick={()=>{ setEditingReview(review); setReviewForm(review); setReviewDialogOpen(true); }}><Pencil className="h-4 w-4"/></Button>
