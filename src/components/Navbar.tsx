...
export const Navbar = () => {
  ...
  const NavLinks = ({ onClick }) => (
    <ul className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 list-none">
      <li><Link to="/" className="hover:text-primary" onClick={onClick}>Home</Link></li>
      ...
      <li><Link to="/products?category=unisex" className="hover:text-primary" onClick={onClick}>Unisex</Link></li>
      <li><Link to="/size-chart" className="hover:text-primary" onClick={onClick}>Size Chart</Link></li>
      <li><Link to="/about" className="hover:text-primary" onClick={onClick}>About</Link></li>
      <li><Link to="/contact" className="hover:text-primary" onClick={onClick}>Contact</Link></li>
      {isAdmin && (
        <li><Link to="/admin" className="hover:text-primary font-semibold" onClick={onClick}>Admin</Link></li>
      )}
    </ul>
  );
        ...
        <div className="md:hidden flex items-center">
          <Sheet>
            ...
            <SheetContent side="left" className="p-6">
              <NavLinks onClick={() => document.querySelector('button[data-state="open"]')?.click()} />
            </SheetContent>
          </Sheet>
        </div>
      </div>
